...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        "--input_path", type=str, required=False, help="The path to the input image. For single image inference only."
    )
    parser.add_argument(
        "--output_path", type=str, required=False, help="The path to the output image. For single image inference only."
    )
    ...
    if args.input_path is not None and args.output_path is not None:
        opt["img_path"] = {"input_img": args.input_path, "output_img": args.output_path}
...
def main():
    ...
    train_loader, train_sampler, val_loader, _total_epochs, total_iters = result
