...
class FaceRestorationHelper:
    ...
    def detect_faces(self, img_path, upsample_num_times=1, only_keep_largest=False):
        ...
        Args:
            ...
            upsample_num_times (int): Upsamples the image before running the face detector.
    ...
    def get_face_landmarks_68(self):
        ...
        for idx, face in enumerate(self.cropped_faces):
            ...
            if len(det_face) == 0:
                ...
                if len(det_face) > 1:
                    print(
                        "Detect several faces in the cropped face. Use the "
    ...
    def paste_faces_to_input_image(self, save_path):
        ...
        for restored_face, inverse_affine in zip(self.restored_faces, self.inverse_affine_matrices):
            ...
            inv_mask_erosion = cv2.erode(
                inv_mask, np.ones((2 * self.upscale_factor, 2 * self.upscale_factor), np.uint8)
            )
