...
def weighted_loss(loss_func):
    ...
    >>> l1_loss(pred, target) tensor(1.3333) >>> l1_loss(pred, target, weight) tensor(1.5000) >>> l1_loss(pred, target,
    reduction="none") tensor([1., 1., 2.]) >>> l1_loss(pred, target, weight, reduction="sum") tensor(3.)
    """
