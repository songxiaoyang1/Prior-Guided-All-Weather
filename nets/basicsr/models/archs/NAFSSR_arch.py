    ...
    def __init__(
        ...
        self.body = MySequential(
            *[
                DropPath(
                    drop_path_rate,
                    NAFBlockSR(width, fusion=(fusion_from <= i <= fusion_to), drop_out_rate=drop_out_rate),
                )
...
if __name__ == "__main__":
    ...
    net = NAFSSR(
        up_scale=2, train_size=train_size, fast_imp=True, width=width, num_blks=num_blks, drop_path_rate=droppath
    )
