...
class ImageRestorationModel(BaseModel):
    ...
    def dist_validation(self, dataloader, current_iter, tb_logger, save_img, rgb2bgr, use_image):
                ...
                if sr_img.shape[2] == 6:
                    ...
                    if self.opt["is_train"]:
                        ...
                        save_gt_img_path = osp.join(
                            self.opt["path"]["visualization"], img_name, f"{img_name}_{current_iter}_gt.png"
                        )
                    else:
        ...
        if self.opt["rank"] == 0:
            ...
            self._log_validation_metric_values(current_iter, dataloader.dataset.opt["name"], tb_logger, metrics_dict)
        return 0.0
